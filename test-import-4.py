...
from tsfresh.examples.har_dataset import load_har_classes_processed, load_har_dataset_processed
...
df = load_har_dataset_processed(filename)
#print timeseries
...
y = load_har_classes_processed(filename)[:10299]
